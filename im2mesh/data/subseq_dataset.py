...
class HumansDataset(data.Dataset):
    ...
    def __init__(self, dataset_folder, fields, split=None,
                 ...
                 length_sequence=17, n_files_per_sequence=-1, n_intervals=1,
        ...
        for c_idx, c in enumerate(categories):
            ...
            # for i, m in enumerate(models_c):
            #     self.models.append(
            #         {'category': c, 'model': m, 'start_idx': start_idx[i], 'idx': global_idx}
            #     )
            #     global_idx += 1
    ...
    def __getitem__(self, idx):
        ...
        #global_idx = self.models[idx]['idx']
    ...
    def subdivide_into_sequences(self, models, models_len):
        ...
        for idx, model in enumerate(models):
            for n in range(0, models_len[idx] - length_sequence + 1, self.n_intervals):
