...
class Generator3D(Generator3DONet):
    ...
    def __init__(self, model, device=None, points_batch_size=100000,
                 ...
                 simplify_nfaces=None, n_time_steps=17, select_steps=[1,16], 
    ...
    def generate_meshes_t(self, vertices_0, faces,c_t=None,
        ...
        #Parallel Iso-Surface Deformations
        n_steps = len(t)
        print(n_steps, t)
        v_t_batch = self.onet_generator.model.transform_to_t(t, 
            vertices_0.expand(n_steps, vertices_0.size(1), vertices_0.size(2)), 
